...
```{r}
ggplot(threat_cons, aes(x = clim_mean, y = climate, label = ISO_Ter1)) +
  geom_point() +
...
```{r}
ggplot(threat_cons, aes(x = land_mean, y = land, label = ISO_Ter1)) +
  geom_point() +
  ggrepel::geom_text_repel() +
  theme_bw() +
  geom_smooth(method = "lm")
...
```{r}
ggplot(threat_cons, aes(x = mar_mean, y = marine, label = ISO_Ter1)) +
  geom_point() +
  ggrepel::geom_text_repel() +
  theme_bw() +
  geom_smooth(method = "lm")
...
```{r}
ggsave(here("Figures/Pressure_indices.png"), width = 13, height = 8, dpi = 300)
```
